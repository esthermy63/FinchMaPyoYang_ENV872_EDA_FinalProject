...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="[figure 5: ARIMA forecast (5 years) - National EE Spending(2021-2024)]" }
...
```{r echo=FALSE, fig.cap="[figure 7:Correlation between Natural Disaster Frequency and Energy Investment]", message=FALSE, warning=FALSE}
...
```{r echo=FALSE, message=FALSE, warning=FALSE,fig.cap="[figure 8:Public Awareness as a Determinant of Energy and Environmental Investment]"}
