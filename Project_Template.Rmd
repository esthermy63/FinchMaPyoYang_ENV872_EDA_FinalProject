...
# Dataset Information
We selected 12 variables of interest from different data sources, from demographic characteristics, disaster frequency, and percentage of public awareness of climate change.
Each annual dataset was processed and summarized in R. For every year, the resulting dataset contains 51 observations and 12 variables (one row per state, plus D.C.).

Below is an example summary output for the 2021 dataset:
```{r echo=FALSE, warning=FALSE}
#summary(df_2021)
#summary(final_data)
...
summary_2021 <- cbind(summary_2021mean,summary_2021SD)
colnames(summary_2021)<- c("Mean", "Standard Deviation")
kable(summary_2021, caption = "Summary Table of 2021 Dataset", digits = 2)
...
For further analysis, dataset from each year were bound by rows, producing a final dataset of 204 objects of 12 variables.
\newpage
