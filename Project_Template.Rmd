...
```{r}
#energy investment map 2021-2024
...
Investment_21_24_clean <- Investment_21_24 %>% mutate(
    across(TotalFedAction_EnergyEnv_2021:TotalFedAction_EnergyEnv_2024)
  ) %>%
  mutate(
    TotalFedAction_EnergyEnv_2021_2024 =
...
ggplot() +  
  ...
  labs(fill='Investment',
       title = "Total Federal Energy and Environment Spending from 2021-2024") + 
