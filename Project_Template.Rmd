...
model <- lm(data = combined2021, Total_EE_Investment ~ `Total population` + Female + child + `Median age (years)` + `Median household income (dollars)` + Gas + Electricity + `All other fuels` + Disasters + `2021`)
summary(model)
...
model_AIC<- lm(data = combined2021, Total_EE_Investment ~ `Total population` + Female + child + `Median age (years)` + `Median household income (dollars)`  + Gas + Electricity + `All other fuels` + Disasters+ `2021`, na.action = na.exclude)
...
model_4 <- lm(data = combined2021, `2021` ~ Total_EE_Investment+ `Total population` + Female + child + `Median age (years)` + `Median household income (dollars)` + Gas + Electricity + `All other fuels` + Disasters,na.action = na.exclude)
step(model_4)
summary(model_4)
